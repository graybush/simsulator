...
[![build-ublue](https://github.com/graybush/simsulator/actions/workflows/build.yml/badge.svg)](https://github.com/graybush/simsulator/actions/workflows/build.yml)
...
```
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/graybush/simsulator:latest
```

This repository builds date tags as well, so if you want to rebase to a particular day's build:

```
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/graybush/simsulator:20221217
```
...
These images are signed with sisgstore's [cosign](https://docs.sigstore.dev/cosign/overview/). You can verify the signature by downloading the `cosign.pub` key from this repo and running the following command:
    ...
    cosign verify --key cosign.pub ghcr.io/graybush/simsulator
